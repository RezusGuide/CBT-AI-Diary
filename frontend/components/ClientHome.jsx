...
export default function ClientHome() {
    ...
    return (
        <div>
            ...
            <div className="stats-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '14px', marginBottom: 'var(--space-xl)' }}>
                ...
                <div className="card" style={{ textAlign: 'center' }}>
                    ...
                    <div className="input-label" style={{ marginBottom: 0 }}>{t('home_stat_ai')}</div>
                </div>
            </div>
